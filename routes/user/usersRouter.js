...
const {list,deleteUser,registerUser,login,updateUser,unSubscribeUser,headImg,subscribeUser,getSubScribeInfo} = require("../../controller/users/usersController")
const multer = require('multer')
const upload = multer({dest: 'public/'})
router
    .get('/subscribe/info',verifyToken(),getSubScribeInfo)
